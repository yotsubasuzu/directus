...
import FilePreview, { type Props as FilePreviewProps } from './file-preview.vue';
import { ref } from 'vue';
import { useI18n } from 'vue-i18n';

export interface FilePreviewReplaceProps extends FilePreviewProps {
	enableImport?: boolean;
}

defineProps<FilePreviewReplaceProps>();
	...
	<div class="file-preview-replace">
		...
		<v-dialog :model-value="replaceFileDialogActive" @esc="replaceFileDialogActive = false">
			<v-card>
				...
				<v-card-text>
					<v-upload :file-id="file.id" :from-url="enableImport" @input="onInput" />
				</v-card-text>
				<v-card-actions>
