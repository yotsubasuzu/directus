	...
	<div class="file">
		<v-menu attached :disabled="loading">
			...
			<v-list>
				...
				<template v-if="!disabled">
					...
					<v-list-item v-if="createAllowed && enableImport" clickable @click="activeDialog = 'url'">
						<v-list-item-icon>
							<v-icon name="link" />
						</v-list-item-icon>
						<v-list-item-content>
		...
		>
			<v-card>
				...
				<v-card-text>
					<v-upload :from-url="enableImport" :folder="folder" @input="onUpload" />
				</v-card-text>
				<v-card-actions>
...
<script setup lang="ts">
	...
	import { useRelationM2O } from './core-clones/composables/use-relation-m2o';
	import { useRelationPermissionsM2O } from './core-clones/composables/use-relation-permissions';
	import { RelationQuerySingle, useRelationSingle } from './core-clones/composables/use-relation-single';
	...
	import DrawerFiles from './core-clones/views/private/components/drawer-files.vue';
	import DrawerItem from './core-clones/views/private/components/drawer-item.vue';
