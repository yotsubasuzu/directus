...
import { addTokenToURL } from '../core-clones/api';
import { formatFilesize } from '../core-clones/utils/format-filesize';
import { getRootPath } from '../core-clones/utils/get-root-path';
import { localizedFormat } from '../core-clones/utils/localized-format';
import { readableMimeType } from '../core-clones/utils/readable-mime-type';
import { userName } from '../core-clones/utils/user-name';
...
function useFolder() {
	...
	const folderLink = computed(() => {
		...
		return `/module-files/folders/${folder.value.id}`;
	});
